...
/*
PdoAdapterкласс выглядит несколько запутанным, на самом деле это простая оболочка, которая использует большую часть функциональных возможностей, которые предлагает PDO прямо из коробки, не подвергая клиентский код подробному API.
*/